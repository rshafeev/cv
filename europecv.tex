...
\ecvitem{Date}{June 2017 --Now}
\ecvitem{Occupation or position held}{Insurance Telematics Project Manager, StarLine, Saint-Petersburg, Russia}
...
\ecvitem{Date}{July 2011 -- February 2012}
\ecvitem{Occupation or position held}{Researcher of Hamburg University of Technology-TUHH”, Germany}
...
\ecvitem{ }{ - Linux (Debian, Ubuntu /Ubuntu Server), MS Windows}

\ecvitem{ }{\textbf{Programming Languages}}
\ecvitem{ }{ - C/C++, Java, Python(Tornado, scripts), C\#, Ruby(basic level), SQL,  PL/pgSQL}

\ecvitem{ }{\textbf{Web-based technologies}}
\ecvitem{ }{ - HTML, JavaScript, EmberJS,  ASP.NET MVC,  Spring MVC, JSP/FreeMarker, Hibernate, Ruby on Rails 4, Tornado}

\ecvitem{ }{\textbf{Continuous integration tools}}
\ecvitem{ }{ - Maven, Jenkins CI, Gitlab CI, Capistrano, Ansible}

\ecvitem{ }{\textbf{Development tools}}
\ecvitem{ }{ - Intellij Idea, Eclipse, RubyMine, PyCharm, CLion, QT Creator,  MS Visual Studio 2012}

\ecvitem{ }{\textbf{Database Management Systems}}
\ecvitem{ }{ - PostgreSQL, Oracle, Redis, MySQL}

\ecvitem{ }{\textbf{Version Control Systems}}
\ecvitem{ }{ - Git, SVN}

\ecvitem{ }{\textbf{Other skills}}
\ecvitem{ }{ - MicroServices: Event-driven architecture(RabbitMQ impl)}
...
\ecvitem{ }{\url{https://bitbucket.org/Roman_Shafeyev/projects-view}}



\ecvitem{PROJECT EXPERIENCE}{}
\ecvitem{ }{\textbf{Insurance Telematics } }
\ecvitem{ }{(July 2016 -- Now)}
...
\ecvitem{PUBLICATIONS}{
	\begin{list}{\textbullet}{}
	  \item R. Shafeyev.  Investigation of tuning parameters of Tabu Search algorithm and its modification  for solving the static Routing Courier Delivery Problem.  // Theoretical and Applied Aspects of Cybernetics. 2018 (not yet published).
