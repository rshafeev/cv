...
\ecvitem{ }{ - PostgreSQL, Oracle, Redis, InfluxDB, ClickHouse (basic level)}


\ecvitem{ }{\textbf{Web-based technologies}}
\ecvitem{ }{ - Tornado, EmberJS(basic level),  Spring MVC (basic level)}
...
\ecvitem{ }{ - Maven, Jenkins CI, Gitlab CI, Ansible, Capistrano (basic level)}
